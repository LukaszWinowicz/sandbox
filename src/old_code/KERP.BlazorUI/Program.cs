...
builder.Services.AddTransient<IRequestHandler<PurchaseOrderReceiptDateUpdateCommand, Result<List<RowValidationResult>>>, PurchaseOrderReceiptDateUpdateCommandHandler>();
